...
const BESCHREIBUNG: Record<CanonicalField, string> = {
  ...
  zutatenliste: "optional, Grundzutaten ohne Mengen zum Filtern",
  schwierigkeit: "optional, wird geschaetzt (Leicht/Mittel/Schwer)",
  status: "optional, fester Wert aus NEW_RECIPE_STATUS in der .env",
  portionen: "optional",
  kueche: "optional",
